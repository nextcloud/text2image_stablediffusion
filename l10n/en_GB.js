OC.L10N.register(
    ...
    "Local Text-To-Image Stable Diffusion" : "Local Text-To-Image Stable Diffusion",
    ...
    "Could not execute the Node.js executable. You may need to set the path to a working executable manually. (See below.)" : "Could not execute the Node.js executable. You may need to set the path to a working executable manually. (See below.)",
    ...
    "The app was installed successfully and will generate images in background processes on request." : "The app was installed successfully and will generate images in background processes on request.",
    "Scheduled transcription Jobs: {scheduled}" : "Scheduled transcription Jobs: {scheduled}",
    "Image generation job currently running" : "Image generation job currently running",
    "No image generation job currently running" : "No image generation job currently running",
    "Resources" : "Resources",
    ...
    "If the shipped Node.js binary doesn't work on your system for some reason you can set the path to a custom node.js binary. Currently supported is Node v18.12 and newer v18 releases." : "If the shipped Node.js binary doesn't work on your system for some reason you can set the path to a custom node.js binary. Currently supported is Node v18.12 and newer v18 releases.",
