OC.L10N.register(
    ...
    {
    "Local Image Generation with Stable Diffusion" : "Generación de imágenes local con Difusión Estable",
    "Image generation using Stable Diffusion by Stability AI running locally" : "Generación de imágenes local usando Difusión Estable usando Stability AI ejecutándose localmente",
    "Image generation provider using Stable Diffusion by Stability AI\n\nThe models run completely on your machine. No private data leaves your servers.\n\nAfter installing this app you will need to run\n\n    occ text2image_stablediffusion:download-model\n\n## Ethical AI Rating\n### Rating: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be ran on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "Proveedor generación de imágenes utilizando Difusión Estable por Stability AI\n\nLos modelos se ejecutan enteramente en su máquina. Ningún dato privado abandona sus servidores.\n\nLuego de instalar esta app necesitará ejecutar\n\nocc text2image_stablediffusion:download-model\n\n## Clasificación ética mediante IA\n### Clasificación: 🟢\n\nPositiva:\n* el software para entrenamiento e inferencia de este modelo es de software de código abierto\n* el modelo entrenado está disponible de forma gratuita y por tanto, puede ser ejecutado en su infraestructura local\n* Los datos de entrenamiento están disponibles de manera gratuita, haciendo posible chequear o corregir el bias u optimizar el rendimiento o uso de CO2.\n\nAprenda más sobre la clasificación ética mediante IA de Nextcloud [en nuestro blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    "Status" : "Estado",
